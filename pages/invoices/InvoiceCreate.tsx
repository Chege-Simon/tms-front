        ...
        <>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md mb-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    ...
                    <div><strong className="block text-gray-500">Total Amount:</strong> <span className="font-bold text-base">{invoice.currency} {parseFloat(invoice.total_amount || 0).toFixed(2)}</span></div>
                </div>
            </div>
